        ...
        <footer className="bg-white py-12 border-t border-slate-50">
            <div className="container mx-auto px-6 text-center">
                <div className="flex justify-center gap-8 mb-10">
                    ...
                    <a href="https://instagram.com/social_standee" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full bg-slate-100 text-black/30 hover:text-brand-dark transition-all">
                        <Instagram className="h-5 w-5" />
                    </a>
                    <a href="mailto:social.standee@gmail.com" className="p-3 rounded-full bg-slate-100 text-black/30 hover:text-brand-dark transition-all">
                        <Mail className="h-5 w-5" />
                    </a>
                    <a href="tel:+918140961702" className="p-3 rounded-full bg-slate-100 text-black/30 hover:text-brand-dark transition-all">
